...
namespace Gibbed.IO
{
    ...
    {
        public static string GetFileName(string fromPath, string extPath = null, bool fullPath = false)
        {
            ...
            if (extPath != null && Path.GetExtension(path) == "")
            {
                path = Path.ChangeExtension(path, extPath);
            }
